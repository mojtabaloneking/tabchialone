...
main = {
  lua_script = "$HOME/sarzminlink-V2/sarzminlink.lua";
};
EOF
    printf "\nDone\n"
}
...
function show_logo_slowly() {
    seconds=0.009
    logo=(
    "sarzminlink TM Project ..."
    "Plus Bot ..."
    "Based On TD-BOT ..."
    "We Are Powerful"
    "by @sarzminlink Or @sarzminlink"
	"Our Team Channel : @sarzminlink"
    )
...
function show_logo() {
    #Adding some color. By @sarzminlink :D
