...
function dl_cb(arg, data)
 ...
 function showedit(msg,data)
  ...
  --------- Text Message --------
   local sarzminlink = msg.content.text
  function check_markdown(text) 
   ...
   ------- Message Content --------
	...
	if msg.content.text then
       print("["..msg.content.text.."]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
	   Message_Type = 'messageText'
    end
    if msg.content.caption then
       print("["..msg.content.caption.."]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
	   Message_Type = 'messageCaption'
    end
    if msg.content._ == "messageChatAddMembers" then
       print("[TG Serviece][Add Member]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'AddUserTG'
    end
    if msg.content._ == "messageChatJoinByLink" then
	   print("[TG Serviece][Join Member]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'JoinedByLinkTG'
    end
    if msg.content._ == "messageDocument" then
       print("[Document]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Document'
    end
    if msg.content._ == "messageSticker" then
       print("[Sticker]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Sticker'
    end
    if msg.content._ == "messageAudio" then
        print("[Audio]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Audio'
    end
    if msg.content._ == "messageVoice" then
        print("[Voice]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Voice'
    end
    if msg.content._ == "messageVideo" then
        print("[Video]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Video'
    end
    if msg.content._ == "messageAnimation" then
        print("[Animation]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Gif'
    end
    if msg.content._ == "messageLocation" then
        print("[Location]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Location'
    end
    if msg.content._ == "messageForwardedFromUser" then
        print("[ForwardedMessage]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'messageForwardedFromUser'
    end
    if msg.content._ == "messageContact" then
        print("[Contact]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Contact'
    end
    if not msg.reply_markup and msg.via_bot_user_id ~= 0 then
        print("[MarkDown or A Bot Message]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Markreed'
    end
    if msg.content.game then
        print("[Game]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Game'
    end
    if msg.content._ == "messagePhoto" then
	    print("[Photo]["..msg.sender_user_id.."]["..msg.chat_id.."][Made By @sarzminlink & @sarzminlink]")
        Message_Type = 'Photo'
    end
...
-----------------------------
if sarzminlink and sarzminlink:match('^П (.*)') and is_sudo(msg) then
local random = sarzminlink:match('П (.*)')
SendMessage(msg.chat_id,random,'md')
end
----------- Stats -----------
if sarzminlink == 'Статистика' and is_sudo(msg) then
             SendMessage(msg.chat_id,'• статистика •\n• '..SGP..' Супер •\n• '..GP..' группа •\n• '..U..' пользователь •\n• '..Link..' цель •\n• '..JOINING..' Статус присоединения •\n• Питаться от [at]sarzminlink •\n• Разработано [at]sarzminlink •','md')
end
---------- Forward ----------
if sarzminlink and sarzminlink:match('^Переслать (%d+)') and is_sudo(msg) then
local random_sgp = sarzminlink:match('Переслать (%d+)')
local FwdLimit = redis:ttl("FwdLimit:"..BOTID) or -2
         ...
         if tonumber(msg.reply_to_message_id) > 0 then
          ...
          local sarzminlink = '• Ваше сообщение Переслано '..random_sgp..' группа •'
             SendMessage(msg.chat_id, sarzminlink, 'md')
...
---------- Add ----------
if sarzminlink and sarzminlink:match('^(Добавить к) (%d+) (%d+)') and is_sudo(msg) then
local match = {
        sarzminlink:match("^(Добавить к) (%d+) (%d+)")
      }
local AddLimit = redis:ttl("AddLimit:"..BOTID) or -2
         if AddLimit == -2 then
          ...
          local sarzminlink = '• Пользователь '..match[3]..' добавлен в '..match[2]..' группу •'
             SendMessage(msg.chat_id, sarzminlink, 'md')
...
----------- Reset -----------
if sarzminlink == 'Сброс' and is_sudo(msg) then
...
----------- Join Stats -----------
if sarzminlink == 'включение соединения' and is_sudo(msg) then
        if JoinStats == 'no' then
...
if sarzminlink == 'отключить соединение' and is_sudo(msg)then
...
----------- Reload -----------
if sarzminlink == 'перезагружать' and is_sudo(msg) then
        dofile('./sarzminlink.lua')
...
------- Auto Join -------
  local JoinLink = (redis:get('JoinLink:'..BOTID) or 'no')
   if is_sudo(msg) then
	if sarzminlink and sarzminlink:match("https://telegram.me/joinchat/%S+") or sarzminlink and sarzminlink:match("https://t.me/joinchat/%S+") or sarzminlink and sarzminlink:match("https://t.me/joinchat/%S+")  or sarzminlink and sarzminlink:match("https://telegram.dog/joinchat/%S+") then
		local sarzminlink = sarzminlink:gsub("t.me","telegram.me")
		for link in sarzminlink:gmatch("(https://telegram.me/joinchat/%S+)") do
...
-- By @sarzminlink And @sarzminlink
-- Developed By sarzminlink Team
-- Believe Us :)
-- Plz Don't Empty This Paragraph
-- لطفا این قسمت را پاک نکنید برای احترام به زحمات برنامه نویس
-- نوشته شده توسط [@sarzminlink]
-- تیم توسعه دهنده [sarzminlink & @sarzminlink]
--------------------------------------
